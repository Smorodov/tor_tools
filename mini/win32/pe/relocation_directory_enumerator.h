	...
	class pe_relocation_directory_enumerator
	{
		...
		public:
			...
			struct iterator
			{
					...
					{
						return _relocation_current == other._relocation_current && _enumerator == other._enumerator;
					}
					bool      operator!=(const iterator& other)       const
					{
						return _relocation_current != other._relocation_current || _enumerator != other._enumerator;
			...
			{
				return iterator(this, _base_relocation.entry);
			}
			iterator end()   const
			{
				return iterator(this, _base_relocation_end);
			}
