		...
		: public key
	{
		...
		public:
			struct blob
			{
				...
				{
					using key_type = provider_key_symmetric_tag;
					static constexpr auto blob_type = BCRYPT_KEY_DATA_BLOB;
					static constexpr auto get_handle = &provider::get_aes_handle<AES_MODE>;
				};
